...
> **Assets = Liabilities + Capital (Fund Balance)**
...
For Local Governments, it also supports:
...
Account Dr.                    XXXX
     To Account                               XXXX
(Being narration of transaction)
--------------------------------------------------------
```
...
| To Property Tax Revenue A/c | | 1,00,000 |
...
| To Government Grant A/c | | 10,00,000 |
...
| Particulars | Debit (₹) | Credit (₹) |
|-------------|-----------|------------|
| Road Construction Work A/c Dr. | 5,00,000 | |
...
| Particulars | Debit (₹) | Credit (₹) |
|-------------|-----------|------------|
| Stationery Expense A/c Dr. | 8,000 | |
...
|-------------|-----------|
| Opening Cash | 50,000 |
| Grant Received | 5,00,000 |
| Property Tax Collected | 80,000 |
| Salary Paid | 1,20,000 |
| Office Furniture Purchased | 40,000 |
| Electricity Bill Paid | 10,000 |
...
```
Cash A/c Dr.                  80,000
    To Property Tax Revenue A/c      80,000
```

#### Salary Paid

```
Salary Expense A/c Dr.      1,20,000
...
| Property Tax Revenue | | 80,000 |
| **Total** | **6,30,000** | **6,30,000** |

The Trial Balance proves that:
...
|--------------|--------------|
| Incomplete records | Complete records |
| Difficult to detect errors | Errors easily detected |
| No Balance Sheet | Balance Sheet prepared |
| Simple bookkeeping | Scientific accounting |
...
For Local Governments such as Gram Panchayats, Municipalities, and Urban Local Bodies, adopting the double-entry system enhances financial transparency, strengthens internal control, and simplifies the preparation of financial statements for audit and public accountability.

Understanding the principles of debit and credit, along with regular recording of transactions through journal entries and ledgers, enables local authorities to maintain sound financial management practices and comply with statutory accounting requirements.
