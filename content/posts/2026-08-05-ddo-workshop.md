...
**Organized by:** Sikkim Finance and Accounts Service Association (SFASA)

**Under the Aegis of:** Finance Department, Government of Sikkim
...
Recognizing the growing need for stronger financial governance, the Sikkim Finance and Accounts Service Association (SFASA), under the aegis of the Finance Department, Government of Sikkim, organized a two-day Capacity Building Workshop at Chintan Bhawan on 7th and 8th July 2025.

The workshop focused on improving financial management practices, strengthening compliance with financial rules, introducing digital financial systems, and reducing audit observations through better documentation and internal controls.
...
- Enhance financial management skills of DDOs and Accounts Officers.
- Improve understanding of Government Financial Rules.
- Promote transparency and accountability.
- Minimize audit observations through better record management.
- Familiarize officers with digital financial systems.
- Encourage uniform implementation of Finance Department instructions.
...
Traditional paper-based systems are gradually being replaced by integrated digital platforms. Financial officers are now expected to manage:
...
At the same time, audit standards have become stricter.

A small procedural mistake can lead to:
...
The workshop commenced with the inaugural session attended by senior officers from the Finance Department and members of SFASA.

The speakers emphasized:

- Financial discipline
- Responsible public expenditure
- Accountability of DDOs
- Efficient utilization of government funds
- Adoption of technology for better governance
...
- Bill preparation
- Salary processing
- Pension-related responsibilities
...
- Spending within approved budget provisions
- Avoiding excess expenditure
- Monitoring available balances
- Proper surrender of savings
- Seeking re-appropriation when necessary
...
- Delayed adjustment of advances
- Unreconciled accounts
- Non-maintenance of registers
- Non-submission of Utilization Certificates
- Purchase without following procurement rules
- Excess payments
- Duplicate claims
...
Participants shared challenges relating to:
...
- Secure handling of Digital Signature Certificates
...
Financial rules exist to protect public money.
...
- Verify budget availability before expenditure.
- Ensure proper sanction before processing bills.
- Maintain updated financial registers.
- Submit bills with complete documentation.
- Reconcile Treasury figures every month.
- Clear pending advances promptly.
- Submit Utilization Certificates on time.
- Follow procurement rules strictly.
...
As government financial systems continue to modernize, the responsibilities of Drawing and Disbursing Officers and Accounts Officers become increasingly important. Technical knowledge, adherence to financial rules, effective record management, and proficiency with digital systems are essential for ensuring efficient and transparent public financial administration.
...
| Area | Key Focus |
|-------|-----------|
| Budget | Spend within allocation |
| Bills | Complete documentation |
| Audit | Prevent recurring objections |
| Procurement | Follow financial rules |
| Treasury | Monthly reconciliation |
| Records | Maintain updated registers |
| Digital Systems | Use IFMS and e-Bill efficiently |
| UCs | Submit on time |
| Compliance | Follow Finance Department instructions |
