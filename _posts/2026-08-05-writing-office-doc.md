...
However, the quality of the output depends largely on the instructions provided. A vague prompt often produces generic content, while a clear instruction results in professional, well-structured documents that require minimal editing.
...
> **Write official notings, letters, memoranda, circulars, office orders, reports, and other official documents in clear, formal, concise, and professional language. Follow standard government and administrative drafting practices. Use proper document structure, subject lines, references, logical sequencing of facts, precise wording, and appropriate official terminology. Maintain an objective tone, avoid informal language, unnecessary explanations, repetition, or emotional expressions. Present recommendations and decisions clearly and professionally.**
...
> **Draft official documents in proper administrative style using clear, concise, professional, and legally appropriate language.**
...
> It is humbly requested that necessary action may kindly be initiated.
...
> The contractor performed very poorly.
...
| Forwarding documents | Enclosed herewith... |
| Reporting completion | The matter has been complied with. |
| Giving instructions | It is directed that... |
...
> Draft an official letter requesting submission of the pending utilization certificate from district offices. Use formal government language, include an appropriate subject line, maintain concise paragraphs, and conclude by requesting submission within seven days.
...
> **Write official notings, letters, memoranda, circulars, office orders, reports, and office documents in clear, formal, concise, and professional language. Follow standard government and administrative drafting practices with proper structure, subject lines, references, logical flow, precise wording, and appropriate official terminology. Avoid informal language, unnecessary explanations, repetition, and emotional expressions. Present facts objectively and conclude with clear recommendations or required actions.**

Using a consistent instruction like this helps generate documents that are easier to review, edit, and issue, regardless of whether you're using ChatGPT, Gemini, or another AI writing assistant.
